...
def check_center_transition_V250420(c: CZSC, **kwargs) -> OrderedDict:
    """
        中枢结构演化信号识别（V250420）：识别中枢是否结束，并判断新中枢走势方向
        ...
        **信号列表示例：**
        ...
        - Signal('15分钟_中枢演化_V250420_新中枢震荡中_任意_任意_0')
    ...
    freq = c.freq.value
    k1, k2, k3 = f"{freq}_中枢演化_V250420".split("_")
    v1, v2 = "其他", "任意"
