# -*- coding: utf-8 -*-
"""
回测：期货单品种 2021 - PenZoneSingleSystemMt5Strategy

运行：
python examples/JSON策略回放_PenZoneSingleSystemMT5_Futures_2021_one.py
"""
...
ROOT_TAG = f"_bt_pen_zone_single_system_mt5_{SYMBOL}_{SDT}_{EDT}_15m"


class OneSymbolPenZoneSingleSystemMt5Strategy(PenZoneSingleSystemMt5Strategy):
    base_freq = FREQ
...
def main():
    ...
    dummy = DummyBacktest(
        strategy=OneSymbolPenZoneSingleSystemMt5Strategy,
    ...
    print(f"回测: {SYMBOL} | {SDT} ~ {EDT} | freq={FREQ}")
