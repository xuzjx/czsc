# -*- coding: utf-8 -*-
"""PenZoneA1EtfStrategy 全市场 ETF 日线回测（T+1 只做多，ATR 止损）

与 _bt_pen_zone_a1_stop_etf_all_t1_20200101_20230101_daily 一致：
- PenZoneA1EtfStrategy + PenZoneA1EtfV1（T+1 long-only）
- 标的：A股场内基金 全部分组
"""
