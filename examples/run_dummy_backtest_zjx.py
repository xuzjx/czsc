...
from czsc.strategies import CzscStrategyExampleZjx

dummy = czsc.DummyBacktest(strategy=CzscStrategyExampleZjx, read_bars=get_raw_bars,
                           signals_module_name='czsc.signals',
                           sdt='20200101', edt='20200301',
                           signals_path=r'D:\QMT投研\CzscStocksBeta\signals',
                           results_path=r'D:\QMT投研\CzscStocksBeta\results_12')
...
if __name__ == '__main__':
    # 这里仅回测前10个品种，作为执行示例
    dummy.execute(symbols[:1], n_jobs=1)
